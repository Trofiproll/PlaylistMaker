...
class SearchActivity : AppCompatActivity() {
    ...
    private val clearBtn: ImageView = findViewById(R.id.search_clear_button)
    private val textInput: EditText = findViewById(R.id.query_input)
    private val backBtn: ImageView = findViewById(R.id.search_back_btn)
    private val recyclerView: RecyclerView = findViewById(R.id.search_recyclerView)
